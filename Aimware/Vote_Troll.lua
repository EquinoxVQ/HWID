...
A Cheater Has Been Detected, Click F1 To Kick Them
...
I Have To Take A Shit. Click F1 To Call A Timeout
...
callbacks.Register("Draw", function()
    ...
    if (itembox_index == 1) then
        doCustomAnimFromTable(pewdiepie);
    elseif (itembox_index == 2) then
        doCustomAnimFromTable(timeout);
    elseif (itembox_index == 3) then
        doCustomAnimFromTable(eatass);
    elseif (itembox_index == 4) then
        doCustomAnimFromTable(resumematch);
    elseif (itembox_index == 5) then
        doCustomAnimFromTable(anti);
    elseif (itembox_index == 6) then
        doCustomAnimFromTable(cheater);
    end
    ...
    if (menuPressed ~= 0) then
        ...
        mgui.menu(25, 25, 160, 300, "Vote Troll", 1);
        mgui.panel(15, 15, 130, 270, "", 2, 1);
        local previewPadding = 15;
        itembox_index, itembox_text = mgui.itembox(25, previewPadding + 30, 70, "Options", animationTypes, 1, 3, 1);
        editName = mgui.edit(100, previewPadding + 30, 175, "Name", "", 4, 1);
        if (mgui.button(30, previewPadding + 80, 25, 240, "Apply Name Change", 6, 1)) then
            silentName, wait, apply_clicked = false, 0, true;
        end
        mgui.label(30, 25, "Name: " .. currentName, 7, 1);
        mgui.menu_mouse(1);
        mgui.item_show();
    end
end);