...
local currentName = '';
local menuPressed = 1;
local animationTypes = { "Static", "Anim", "Time", "Hitler", 'Stars', 'Fishes' };
...
callbacks.Register("Draw", function()
    ...
    if (menuPressed ~= 0) then
        ...
        itembox_index, itembox_text = mgui.itembox(25, previewPadding + 30, 70, "Select Anim", animationTypes, 1, 3, 1);
